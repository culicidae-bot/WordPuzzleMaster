...
export default function Game() {
    ...
    return (<div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-between max-w-2xl mx-auto w-full px-4 pb-6">
        ...
        <LetterCircle letters={level.availableLetters} onWordFormed={handleWordFound} onShuffle={() => playSoundEffect("shuffle")} onUseHint={handleUseHint} onToggleMultiplayer={() => setShowMultiplayer(true)}/>
      </main>
