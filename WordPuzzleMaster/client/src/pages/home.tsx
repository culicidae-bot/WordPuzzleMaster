    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4">
      ...
      <div className="mt-16 flex flex-col items-center gap-2 text-white/60 text-sm">
        <div className="flex flex-col md:flex-row items-center gap-4 mb-2">
          <img
            src="/WordPuzzleMaster/attached_assets/image_1747483781001.png"
            alt="Isabela State University Logo"
            className="w-16 h-16 rounded-full border-2 border-accent bg-white object-cover shadow-md"
          />
          <img
            src="/WordPuzzleMaster/attached_assets/image_1747483790472.png"
            alt="CCS ICT Logo"
            className="w-16 h-16 rounded-full border-2 border-accent bg-white object-cover shadow-md"
          />
        </div>
