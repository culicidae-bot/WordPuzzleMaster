...
import { Users, ArrowLeft, PlusCircle, LogIn, Crown } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-2xl">
        ...
        {view !== "lobby" && (
          <Button
            className="mb-4 text-white/80 hover:text-white bg-transparent hover:bg-accent/10"
            onClick={() => {
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Select 
                    ...
                    onValueChange={(val: string) => setSelectedLevelId(parseInt(val))}
                  >
                    <SelectTrigger className="bg-background/50">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Input
                    id="room-code"
                    value={joinRoomCode}
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setJoinRoomCode(e.target.value.toUpperCase())}
                    className="bg-background/50"
