...
export function RegisterModal({ open, onClose, onSuccess, }) {
    ...
    const form = useForm({
        resolver: zodResolver(registerSchema), // Use 'as any' to avoid type recursion
        defaultValues: {
            username: "",
            password: "",
            confirmPassword: "",
      ...
      <DialogContent className="sm:max-w-[425px] bg-slate-800 text-white border-slate-700 relative">
        <div className="flex flex-row items-center justify-between gap-4">
          ...
          <div className="hidden md:flex items-center justify-center w-20 h-20">
            <img src="/attached_assets/isu-logo.png" alt="ISU Logo" className="logo-glow border-4 border-green-600 shadow-green-400" style={{
            width: "70px",
            height: "70px",
            objectFit: "cover",
            borderRadius: "50%",
          ...
          {/* Right Logo (ICT) */}
          <div className="hidden md:flex items-center justify-center w-20 h-20">
            <img src="/attached_assets/ict-logo.png" alt="ICT Logo" className="logo-glow border-4 border-yellow-400 shadow-yellow-300" style={{
            width: "70px",
            height: "70px",
            objectFit: "cover",
            borderRadius: "50%",
